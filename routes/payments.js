    ...
    router.post('/create-checkout-session', async (req, res) => {
        try {
            const session = await stripe.checkout.sessions.create({
                ...
                mode: 'payment',
                success_url: 'https://twoja-strona.pl/success', // URL przekierowania po udanej płatności
                cancel_url: 'https://twoja-strona.pl/cancel', // URL przekierowania po anulowaniu płatności
            });
